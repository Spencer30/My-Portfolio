const projects = [
  ...
  },
  {
    ...
    link: 'https://bowlingbuddy.herokuapp.com/'
  },
  {
    id: 13,
    title: 'Search The News',
    description: 'Built with React and Node. Google like search engine retrieves news from an api based on an user\'s search. Using Semantic UI to style the project.',
  ...
  },
  {
    ...
    description: 'A blackjack game that uses html, css, and javascript. Play against a computer dealer.',
  ...
  },
  {
    ...
    description: 'Calculate your bowling score that utilizes html, css and javascript.',
  ...
  },
  {
    ...
    description: 'A simple web app that uses html, css, and javascript to bring a childhood toy to the web.',
